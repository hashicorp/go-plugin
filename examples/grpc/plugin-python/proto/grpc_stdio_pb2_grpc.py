...
from proto import grpc_stdio_pb2 as proto_dot_grpc__stdio__pb2
...
class GRPCStdioStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamStdio = channel.unary_stream(
            ...
            response_deserializer=proto_dot_grpc__stdio__pb2.StdioData.FromString,
        )
...
def add_GRPCStdioServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "StreamStdio": grpc.unary_stream_rpc_method_handler(
            ...
            response_serializer=proto_dot_grpc__stdio__pb2.StdioData.SerializeToString,
        ),
    }
...
class GRPCStdio(object):
    ...
    def StreamStdio(
        ...
        return grpc.experimental.unary_stream(
            ...
            proto_dot_grpc__stdio__pb2.StdioData.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
