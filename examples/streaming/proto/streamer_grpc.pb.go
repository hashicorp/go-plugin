...
func (x *streamerServiceReadClient) Recv() (*Read_Response, error) {
	m := new(Read_Response)
...
func (x *streamerServiceWriteClient) Send(m *Write_Request) error {
...
func (x *streamerServiceReadServer) Send(m *Read_Response) error {
...
func (x *streamerServiceWriteServer) Recv() (*Write_Request, error) {
	m := new(Write_Request)
