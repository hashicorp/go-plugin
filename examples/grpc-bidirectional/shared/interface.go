...
func (p *KVPlugin) GRPCServer(broker *plugin.GRPCBroker, s *grpc.Server) error {
	proto.RegisterKVServer(s, &GRPCServer{
		Impl:   p.Impl,
		broker: broker,
	})
	return nil
...
func (p *KVPlugin) GRPCClient(broker *plugin.GRPCBroker, c *grpc.ClientConn) (interface{}, error) {
	return &GRPCClient{
...
var _ plugin.GRPCPlugin = &KVPlugin{}
