...
type GRPCClient struct {
	...
	addHelper *grpc.Server
}

func (m *GRPCClient) Init(a AddHelper) error {
...
func (m *GRPCServer) Init(ctx context.Context, req *proto.InitRequest) (*proto.Empty, error) {
	conn, err := m.broker.Dial(req.AddHelperID)
	if err != nil {
		return nil, err
	}
	...
	return &proto.Empty{}, m.Impl.Init(a)
}
