...
const file_streamer_proto_rawDesc = "" +
	"\n" +
	"\x0estreamer.proto\x12\x05proto\"A\n" +
	"\x04Read\x1a\t\n" +
	"\aRequest\x1a.\n" +
	"\rResponseChunk\x12\x1d\n" +
	"\n" +
	"read_bytes\x18\x01 \x01(\fR\treadBytes\"I\n" +
	"\x05Write\x1a4\n" +
	"\fRequestChunk\x12$\n" +
	"\x0ebytes_to_write\x18\x01 \x01(\fR\fbytesToWrite\x1a\n" +
	"\n" +
	"\bResponse\"U\n" +
	"\tConfigure\x1a<\n" +
	"\aRequest\x12\x12\n" +
	...
	"\n" +
	"chunk_size\x18\x02 \x01(\x03R\tchunkSize\x1a\n" +
	"\n" +
	"\bResponse2\xca\x01\n" +
	"\x0fStreamerService\x12@\n" +
	"\tConfigure\x12\x18.proto.Configure.Request\x1a\x19.proto.Configure.Response\x128\n" +
	"\x04Read\x12\x13.proto.Read.Request\x1a\x19.proto.Read.ResponseChunk0\x01\x12;\n" +
	"\x05Write\x12\x19.proto.Write.RequestChunk\x1a\x15.proto.Write.Response(\x01B\tZ\a./protob\x06proto3"
